...
export default function Canvas() {
  ...
  function onMouseUp() {
    ...
    if (nodeDragging && selectedConnectionNodeId) {
      ...
      const { history, components: currentComponents, wires: currentWires, texts: currentTexts } = useAppStore.getState()
          ...
          if (wire) {
            ...
            if (segmentIndex >= 0) {
              ...
              if (componentId) {
                ...
                divideWireAtPoint(wire.id, segmentIndex, snappedResult.x, snappedResult.y, componentId)
